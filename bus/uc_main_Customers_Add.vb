...
Public Class uc_main_Customers_Add
    Private Sub ButtonCancel_Click(sender As Object, e As EventArgs) Handles ButtonCancel.Click
        Me.Visible = False  'Hide on clicking cancel
    End Sub

    Private Sub ButtonSaveCustomer_Click(sender As Object, e As EventArgs) Handles ButtonSaveCustomer.Click
    ...
    Private Function SaveCustomer(ByVal person_id As Integer) As Boolean
        Dim objGlobal As clsGlobal = New clsGlobal
        Dim ireturn As Boolean

        Dim sql As String = "INSERT INTO tbl_customer(person_id) VALUES (@person_id)"
        Dim cmd = New MySqlCommand(sql, objGlobal.con)
