...
Public Class uc_custom_AddUser
    ...
    Private Sub ButtonSaveUser_Click(sender As Object, e As EventArgs) Handles ButtonSaveUser.Click
        '1. Declare Variables
        Dim fname, lname, email, phone, nat_idNum, username, password, password2 As String
        ...
        password2 = TB_passwordcheck.Text
        '3. Chech if password 1 and 2 are the same
        If password = password2 Then
            '4. Pass inputs to save person Function (go to SavePerson function for step 5)
            Dim status As Boolean = SavePerson(fname, lname, phone, email, nat_idNum, username, password)
            If status = True Then
    ...
    End Sub
    Private Function SavePerson(ByVal fname As String, ByVal lname As String, ByVal phone As String, ByVal email As String, ByVal nat_idNum As String, ByVal username As String, ByVal password As String) As Boolean
        ...
        Try
            ...
            If cmd.ExecuteNonQuery() > 0 Then
                ...
                SaveUser(person_id, username, password)
    ...
    Private Function SaveUser(ByVal person_id As Integer, ByVal username As String, ByVal password As String) As Boolean
        Dim objGlobal As clsGlobal = New clsGlobal
        Dim ireturn As Boolean

        Dim sql As String = "INSERT INTO tbl_users(user_type, username, password, person_id) VALUES (@user_type,@username,@password,@person_id)"
        Dim cmd = New MySqlCommand(sql, objGlobal.con)
